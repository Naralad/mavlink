...
#define MAVLINK_MSG_ID_KEY_COMMAND_LEN 4
#define MAVLINK_MSG_ID_KEY_COMMAND_MIN_LEN 4
#define MAVLINK_MSG_ID_229_LEN 4
#define MAVLINK_MSG_ID_229_MIN_LEN 4

#define MAVLINK_MSG_ID_KEY_COMMAND_CRC 38
#define MAVLINK_MSG_ID_229_CRC 38
...
#define MAVLINK_MESSAGE_INFO_KEY_COMMAND { \
    ...
    "KEY_COMMAND", \
    1, \
    {  { "command", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_key_command_t, command) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_KEY_COMMAND { \
                               ...
                               int32_t command)
{
    ...
    _mav_put_int32_t(buf, 0, command);
...
static inline void mavlink_msg_key_command_send(mavlink_channel_t chan, int32_t command)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_KEY_COMMAND_LEN];
    _mav_put_int32_t(buf, 0, command);
 ...
 */
static inline void mavlink_msg_key_command_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  int32_t command)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  
 */
static inline int32_t mavlink_msg_key_command_get_command(const mavlink_message_t* msg)
{
