...
TEST(common, ODAR_INFO)
{
    ...
    packet_in.k_r = 185.0;
    packet_in.k_w = 213.0;
    packet_in.k_ri = 241.0;

    mavlink::common::msg::ODAR_INFO packet1{};
    mavlink::common::msg::ODAR_INFO packet2{};
    ...
    EXPECT_EQ(packet1.time_usec, packet2.time_usec);
    EXPECT_EQ(packet1.gain_scale, packet2.gain_scale);
    EXPECT_EQ(packet1.fuse_flag, packet2.fuse_flag);
    EXPECT_EQ(packet1.feedback_flag, packet2.feedback_flag);
    EXPECT_EQ(packet1.k_p, packet2.k_p);
    EXPECT_EQ(packet1.k_d, packet2.k_d);
    EXPECT_EQ(packet1.k_i, packet2.k_i);
    EXPECT_EQ(packet1.k_r, packet2.k_r);
    EXPECT_EQ(packet1.k_w, packet2.k_w);
    EXPECT_EQ(packet1.k_ri, packet2.k_ri);
}

#ifdef TEST_INTEROP
TEST(common_interop, ODAR_INFO)
{
    mavlink_message_t msg;
    ...
    mavlink_msg_odar_info_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.time_usec, packet2.time_usec);
    EXPECT_EQ(packet_in.gain_scale, packet2.gain_scale);
    EXPECT_EQ(packet_in.fuse_flag, packet2.fuse_flag);
    EXPECT_EQ(packet_in.feedback_flag, packet2.feedback_flag);
    EXPECT_EQ(packet_in.k_p, packet2.k_p);
    EXPECT_EQ(packet_in.k_d, packet2.k_d);
    EXPECT_EQ(packet_in.k_i, packet2.k_i);
    EXPECT_EQ(packet_in.k_r, packet2.k_r);
    EXPECT_EQ(packet_in.k_w, packet2.k_w);
    EXPECT_EQ(packet_in.k_ri, packet2.k_ri);
...
TEST(common, ODAR_POSE)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::ODAR_POSE packet_in{};
    packet_in.time_usec = 93372036854775807ULL;
    packet_in.x = 73.0;
    packet_in.y = 101.0;
    packet_in.z = 129.0;
    ...
    mavlink::common::msg::ODAR_POSE packet1{};
    mavlink::common::msg::ODAR_POSE packet2{};
...
TEST(common_interop, ODAR_POSE)
{
    ...
    mavlink_msg_odar_pose_encode(1, 1, &msg, &packet_c);
...
TEST(common, ODAR_CHANNEL_COMMAND)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::ODAR_CHANNEL_COMMAND packet_in{};
    packet_in.time_usec = 93372036854775807ULL;
    packet_in.channel = 963497880;
    packet_in.float_value = 101.0;
    packet_in.int_value = 963498296;

    mavlink::common::msg::ODAR_CHANNEL_COMMAND packet1{};
    mavlink::common::msg::ODAR_CHANNEL_COMMAND packet2{};
    ...
    EXPECT_EQ(packet1.time_usec, packet2.time_usec);
    EXPECT_EQ(packet1.channel, packet2.channel);
    EXPECT_EQ(packet1.float_value, packet2.float_value);
    EXPECT_EQ(packet1.int_value, packet2.int_value);
}

#ifdef TEST_INTEROP
TEST(common_interop, ODAR_CHANNEL_COMMAND)
{
    mavlink_message_t msg;
    ...
    mavlink_odar_channel_command_t packet_c {
    ...
    mavlink_msg_odar_channel_command_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.time_usec, packet2.time_usec);
    EXPECT_EQ(packet_in.channel, packet2.channel);
    EXPECT_EQ(packet_in.float_value, packet2.float_value);
    EXPECT_EQ(packet_in.int_value, packet2.int_value);
...
TEST(common, ODAR_DESIRED_POSE)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::ODAR_DESIRED_POSE packet_in{};
    packet_in.time_usec = 93372036854775807ULL;
    packet_in.x = 73.0;
    packet_in.y = 101.0;
    packet_in.z = 129.0;
    ...
    mavlink::common::msg::ODAR_DESIRED_POSE packet1{};
    mavlink::common::msg::ODAR_DESIRED_POSE packet2{};
...
#ifdef TEST_INTEROP
TEST(common_interop, ODAR_DESIRED_POSE)
{
    mavlink_message_t msg;
    ...
    mavlink_odar_desired_pose_t packet_c {
    ...
    mavlink_msg_odar_desired_pose_encode(1, 1, &msg, &packet_c);
...
TEST(common, ODAR_PWM)
{
    ...
    mavlink::common::msg::ODAR_PWM packet_in{};
    packet_in.time_usec = 93372036854775807ULL;
    packet_in.pwm1 = 17651;
    packet_in.pwm2 = 17755;
    packet_in.pwm3 = 17859;
    packet_in.pwm4 = 17963;
    packet_in.pwm5 = 18067;
    packet_in.pwm6 = 18171;
    packet_in.pwm7 = 18275;
    packet_in.pwm8 = 18379;

    mavlink::common::msg::ODAR_PWM packet1{};
    mavlink::common::msg::ODAR_PWM packet2{};
    ...
    EXPECT_EQ(packet1.time_usec, packet2.time_usec);
    EXPECT_EQ(packet1.pwm1, packet2.pwm1);
    EXPECT_EQ(packet1.pwm2, packet2.pwm2);
    EXPECT_EQ(packet1.pwm3, packet2.pwm3);
    EXPECT_EQ(packet1.pwm4, packet2.pwm4);
    EXPECT_EQ(packet1.pwm5, packet2.pwm5);
    EXPECT_EQ(packet1.pwm6, packet2.pwm6);
    EXPECT_EQ(packet1.pwm7, packet2.pwm7);
    EXPECT_EQ(packet1.pwm8, packet2.pwm8);
}

#ifdef TEST_INTEROP
TEST(common_interop, ODAR_PWM)
{
    mavlink_message_t msg;
    ...
    mavlink_msg_odar_pwm_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.time_usec, packet2.time_usec);
    EXPECT_EQ(packet_in.pwm1, packet2.pwm1);
    EXPECT_EQ(packet_in.pwm2, packet2.pwm2);
    EXPECT_EQ(packet_in.pwm3, packet2.pwm3);
    EXPECT_EQ(packet_in.pwm4, packet2.pwm4);
    EXPECT_EQ(packet_in.pwm5, packet2.pwm5);
    EXPECT_EQ(packet_in.pwm6, packet2.pwm6);
    EXPECT_EQ(packet_in.pwm7, packet2.pwm7);
    EXPECT_EQ(packet_in.pwm8, packet2.pwm8);
...
TEST(common, ODAR_WRENCH)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::ODAR_WRENCH packet_in{};
    packet_in.time_usec = 93372036854775807ULL;
    packet_in.Fx = 73.0;
    packet_in.Fy = 101.0;
    packet_in.Fz = 129.0;
    ...
    mavlink::common::msg::ODAR_WRENCH packet1{};
    mavlink::common::msg::ODAR_WRENCH packet2{};
    ...
    EXPECT_EQ(packet1.time_usec, packet2.time_usec);
    EXPECT_EQ(packet1.Fx, packet2.Fx);
    EXPECT_EQ(packet1.Fy, packet2.Fy);
    EXPECT_EQ(packet1.Fz, packet2.Fz);
    EXPECT_EQ(packet1.Tx, packet2.Tx);
    EXPECT_EQ(packet1.Ty, packet2.Ty);
    EXPECT_EQ(packet1.Tz, packet2.Tz);
}

#ifdef TEST_INTEROP
TEST(common_interop, ODAR_WRENCH)
{
    mavlink_message_t msg;
    ...
    mavlink_odar_wrench_t packet_c {
         93372036854775807ULL, 73.0, 101.0, 129.0, 157.0, 185.0, 213.0
    };
    ...
    mavlink_msg_odar_wrench_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.time_usec, packet2.time_usec);
    EXPECT_EQ(packet_in.Fx, packet2.Fx);
    EXPECT_EQ(packet_in.Fy, packet2.Fy);
    EXPECT_EQ(packet_in.Fz, packet2.Fz);
    EXPECT_EQ(packet_in.Tx, packet2.Tx);
    EXPECT_EQ(packet_in.Ty, packet2.Ty);
    EXPECT_EQ(packet_in.Tz, packet2.Tz);
